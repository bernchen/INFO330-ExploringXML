...
# Extract data from the XML and insert into database
...
c.execute("INSERT INTO pokemon (pokedex, name, classification, generation, hp, attack, defense, speed, sp_attack, sp_defense, height, weight) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", (pokedex, name, classification, generation, hp, attack, defense, speed, sp_attack, sp_defense, height, weight))
